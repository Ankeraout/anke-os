#ifndef __KERNEL_ARCH_X86_BIOS_H__
#define __KERNEL_ARCH_X86_BIOS_H__
...
} __attribute__((packed)) bios_callContext_t;

void bios_init();
void bios_call(uint8_t interruptNumber, bios_callContext_t *context);
