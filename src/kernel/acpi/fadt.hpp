#ifndef __KERNEL_ACPI_FADT_HPP__
#define __KERNEL_ACPI_FADT_HPP__
...
namespace kernel {
    enum {
        FADT_ADDRESSSPACE_SYSTEM_MEMORY = 0,
        FADT_ADDRESSSPACE_SYSTEM_IO = 1,
        FADT_ADDRESSSPACE_PCI_CONFIGURATION_SPACE = 2,
        FADT_ADDRESSSPACE_EMBEDDED_CONTROLLER = 3,
        FADT_ADDRESSSPACE_SMBUS = 4,
        FADT_ADDRESSSPACE_CMOS = 5,
        FADT_ADDRESSSPACE_PCI_DEVICE = 6,
        FADT_ADDRESSSPACE_IPMI = 7,
        FADT_ADDRESSSPACE_GPIO = 8,
        FADT_ADDRESSSPACE_PCC = 9,
    };

    enum {
        FADT_ACCESSSIZE_8 = 1,
        FADT_ACCESSSIZE_16 = 2,
        FADT_ACCESSSIZE_32 = 3,
        FADT_ACCESSSIZE_64 = 4
    };
